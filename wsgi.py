...
from implementations.feature6_announcements.routes import bp as feature6_bp   # ✅ أضف هذا
...
app.register_blueprint(feature6_bp)  # ✅ تسجيل مسار الإعلانات
app.register_blueprint(feature7_bp)
if __name__ == "__main__":
    socketio.run(app, port=5070)
